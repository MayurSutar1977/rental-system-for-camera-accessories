...
import com.app.pojos.entity.RentalEquipment;
import com.app.services.interfaces.IRentalEquipmentService;
...
public class RentalEquipmentController {
	...
	{
		System.out.println("Inside RentalEquipment Controller");
	}
